...
import enchant
ddd=enchant.request_pwl_dict("1000-most-common-words.txt")
...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=50, y=3, width=300, height=400)  # Adjusted position and size

        self.panel2 = tk.Label(self.root)  # Initialize image panel
        self.panel2.place(x=450, y=100, width=300, height=300)  # Adjusted position and size

        self.T = tk.Label(self.root)
        self.T.place(x=150, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Courier", 20, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=200, y=450)

        self.T1 = tk.Label(self.root)
        self.T1.place(x=10, y=450)
        self.T1.config(text="Character :", font=("Courier", 20, "bold"))

        self.panel5 = tk.Label(self.root)  # Sentence
        self.panel5.place(x=180, y=490)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=10, y=490)
        self.T3.config(text="Sentence :", font=("Courier", 20, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=530)
        self.T4.config(text="Suggestions :", fg="red", font=("Courier", 20, "bold"))

        # Adjusted button positions
        self.b1 = tk.Button(self.root)
        self.b1.place(x=50, y=560)

        self.b2 = tk.Button(self.root)
        self.b2.place(x=150, y=560)

        self.b3 = tk.Button(self.root)
        self.b3.place(x=250, y=560)

        self.b4 = tk.Button(self.root)
        self.b4.place(x=350, y=560)

        self.speak = tk.Button(self.root)
        self.speak.place(x=550, y=530)
        self.speak.config(text="Speak", font=("Courier", 15), wraplength=80, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=650, y=530)
        self.clear.config(text="Clear", font=("Courier", 15), wraplength=80, command=self.clear_fun)
